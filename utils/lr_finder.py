...
class LRFinder(object):
    ...
    在两个学习速度边界之间以指数学习方式增加。它提供了有价值的信息，说明在一系列学习率下，
    网络的训练效果如何，最佳学习率是多少。
    ...
    def _train_batch(self, inputs, labels):
        ...
        loss2  = F.binary_cross_entropy_with_logits(out2, labels)
        loss3  = F.binary_cross_entropy_with_logits(out3, labels)
        loss4  = F.binary_cross_entropy_with_logits(out4, labels)
        loss5  = F.binary_cross_entropy_with_logits(out5, labels)
...
class LinearLR(_LRScheduler):
    ...
    iterations.通过多次迭代，线性增加两个边界之间的学习速率。
...
class ExponentialLR(_LRScheduler):
    ...
    iterations.在多次迭代中，以指数方式增加两个边界之间的学习速率。
